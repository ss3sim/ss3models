...
51 # MSY: 1= set to F(SPR); 2=calc F(MSY); 3=set to F(Btgt); 4=set to F(endyr) 
51 # SPR target (e.g. 0.40)
...
#  2 1634036837 25971 60 60 60 # after processing 
...
#_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF  (enter actual year, or values of 0 or -integer to be rel. endyr)
 1.33326e+179 4.70108e+180 2.4347e-022 1.33294e+179

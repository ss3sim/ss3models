...
You can test all the operating model setups (run them through SS3) and run all the \code{.dat} files through `ss3sim::check_data()` by running the following in the base `ss3models` folder:
